...
Public Class MDIPrincipal
    ...
    ''' </summary>
    Public Shared Sub AcercaDe() Handles menuFileAcercaDe.Click
        ...
        MessageBox.Show($"{producto} v{vers} ({fvi.FileVersion}){vbCrLf}{vbCrLf}" &
                        $"{descL}{vbCrLf}" &
                        $"{desc1}{vbCrLf}{vbCrLf}-------------------------------------------{vbCrLf}{vbCrLf}" &
                        $"{versionUtil}",
                        $"Acerca de {producto}",
    ...
    ''' </summary>
    Private Shared Sub Inicializar()
    ...
    Friend Sub AsignarNavegar(elForm1 As Form1)
        ...
        Dim marcador = New Marcadores(elForm1.richTextBoxCodigo.SelectionStart, elForm1.NombreFichero)
