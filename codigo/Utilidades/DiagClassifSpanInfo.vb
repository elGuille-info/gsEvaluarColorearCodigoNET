...
Public Class DiagInfo
    ...
    'Public Function GetLineStart() As Integer
    '    Return StartLinePosition.Line
    'End Function

    'Public Function GetCharacterStart() As Integer
    '    Return StartLinePosition.Character
    'End Function

    'Public Function GetLineEnd() As Integer
    '    Return EndLinePosition.Line
    'End Function

    'Public Function GetCharacterEnd() As Integer
    '    Return EndLinePosition.Character
    'End Function
